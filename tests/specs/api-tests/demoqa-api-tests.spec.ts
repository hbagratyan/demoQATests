...
test.describe('API проверки создания пользователя, добавления и удаления книг', () => {
    ...
    test('Создание пользователя с валидными кредами - должен вернуться 201 ответ', async ({userClient, dataGenerator}) => {
    ...
    test('Создание пользователя без username - должен вернуться 400 ответ', async ({userClient, dataGenerator}) => {
    ...
    test('Создание пользователя без пароля - должен вернуться 400 ответ', async ({userClient, dataGenerator}) => {
    ...
    test('Добавление книги пользователю - должен вернуться 201 ответ', async ({authorizedUser, bookClient}) => {
        // 1. Get valid ISBN
    ...
    test('Добавление книги пользователю без токена - должен вернуться 201 ответ', async ({authorizedUser, bookClient}) => {
        const isbn = await bookClient.getValidIsbn();
        const response = await bookClient.addBook(authorizedUser.userId, '', isbn)
        expect(response.status).toBe(401);
    });

    test('Удаление книги у пользователя - должен вернуться 204 ответ', async ({authorizedUser, bookClient}) => {
    ...
    test('Удаление книги у пользователя без токена - должен вернуться 204 ответ', async ({authorizedUser, bookClient}) => {
